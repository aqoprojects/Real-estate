...
const LandingPage = () => {
  return (
    <>
      <HeaderComponent />
      <main className=''>
        <article className='flex justify-between items-center-safe px-25 py-26'>
          <section className='flex flex-col gap-8'>
            <div className="max-w-160 space-y-10">
              <h1 className="text-8xl font-extrabold">Modern living for everyone</h1>
              <p className="text-2xl">We provide a complete service for the sale, purchase or rental of real estate. We have been operating in spain more than 15 years.</p>
            </div>
            <div className='flex items-stretch w-full gap-3'>
              ...
              <Button1
                ...
                texts={{ text1: 'Search' }}
                extra={'bg-green-600 rounded-sm !w-35 justify-center'}
              />
            </div>
          </section>
          <section className=''>
        ...
        <article className='bg-cyan-50 py-26'>
          <section className='px-25 py-10 flex items-center-safe justify-between'>
          ...
          <section className='pl-25 flex items-center-safe gap-5'>
        ...
        <article className='bg-white py-26'>
          <section className='px-25 py-10 flex items-center-safe justify-between '>
            <div className='space-y-3 leading-5 max-w-130'>
          ...
          <section className='px-2 space-y-6'>
            <div className='flex items-center-safe gap-5'>
              <div className='max-w-100 bg-teal-50 p-4 pt-5 pb-10 space-y-5'>
                <div>
        ...
        <article className='bg-white py-26 px-25  flex justify-center-safe gap-20'>
          <section>
            <div>
              <img src={staff1} alt="about us" className='w-140 h-95 rounded-sm' />
            </div>
          </section>
          <section className='w-150 space-y-5'>
